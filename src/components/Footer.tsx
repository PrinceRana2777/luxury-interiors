          ...
          <div>
            ...
            <ul className="space-y-6 text-sm text-gray-400 font-medium">
              ...
              <li className="flex items-center gap-4">
                ...
                <a href="mailto:luxuryinteriorsmanufacturer@gmail.com?subject=Interior Inquiry" className="hover:text-luxury-gold transition-colors">luxuryinteriorsmanufacturer@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
