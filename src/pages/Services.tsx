...
const bedsImages = [
  'https://iili.io/BU8siJ4.md.jpg',
  'https://iili.io/BU8sQbS.md.jpg',
  'https://iili.io/BU8stz7.md.jpg',
  'https://iili.io/BU8s6gf.md.jpg',
  'https://iili.io/BU8spqu.md.jpg',
  'https://iili.io/BU8sy0b.md.jpg',
  'https://iili.io/BU8L9gj.md.jpg',
  'https://iili.io/BU8LJdx.md.jpg'
];

const diningTableImages = [
  'https://iili.io/BUS3s7S.md.jpg',
  'https://iili.io/BUS3414.md.jpg',
  'https://iili.io/BUS36rl.md.jpg',
  'https://iili.io/BUS3i22.md.jpg',
  'https://iili.io/BUS3Lk7.md.jpg',
  'https://iili.io/BUS3Qp9.md.jpg',
  'https://iili.io/BUS3tIe.md.jpg'
];

const teaTableImages = [
  'https://iili.io/BUSuG8g.md.jpg',
  'https://iili.io/BUSuhtR.md.jpg',
  'https://iili.io/BUSuV9a.md.jpg',
  'https://iili.io/BUSuWAJ.md.webp',
  'https://iili.io/BUSuwnp.md.jpg',
  'https://iili.io/BUSuNMN.md.webp',
  'https://iili.io/BUSuOPI.jpg',
  'https://iili.io/BUSukFt.jpg'
];
...
const Services = () => {
  ...
  return (
    <div className="pt-24">
      ...
      <section id="sofa" className="bg-white scroll-mt-[100px]">
      ...
      {/* Beds Collection Gallery Section */}
      <section id="beds" className="bg-luxury-cream scroll-mt-[100px]">
        <div className="container-luxury">
          <div className="text-center mb-16">
            <span className="text-luxury-gold uppercase tracking-[0.5em] text-xs font-bold mb-4 block">Elegant Comfort</span>
            <h2 className="text-4xl md:text-6xl font-serif mb-6">Beds Collection</h2>
            <p className="text-gray-500 max-w-2xl mx-auto font-medium">
              Elegant and modern bed designs crafted for comfort, style, and luxurious living.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {bedsImages.map((img, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
      ...
      <section id="kitchen" className="bg-white scroll-mt-[100px]">
        <div className="container-luxury">
          <div className="text-center mb-16">
      ...
      {/* Dining Table Collection Gallery Section */}
      <section id="dining" className="bg-luxury-cream scroll-mt-[100px]">
        <div className="container-luxury">
          <div className="text-center mb-16">
            <span className="text-luxury-gold uppercase tracking-[0.5em] text-xs font-bold mb-4 block">Grand Dining</span>
            <h2 className="text-4xl md:text-6xl font-serif mb-6">Dining Table Collection</h2>
            <p className="text-gray-500 max-w-2xl mx-auto font-medium">
              Modern and elegant dining table designs crafted to enhance your dining experience with style and comfort.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {diningTableImages.map((img, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
      ...
      {/* Tea Table Collection Gallery Section */}
      <section id="tea-table" className="bg-white scroll-mt-[100px]">
        <div className="container-luxury">
          <div className="text-center mb-16">
            <span className="text-luxury-gold uppercase tracking-[0.5em] text-xs font-bold mb-4 block">Elegant Accent</span>
            <h2 className="text-4xl md:text-6xl font-serif mb-6">Tea Table Collection</h2>
            <p className="text-gray-500 max-w-2xl mx-auto font-medium">
              Stylish and modern tea table designs crafted to enhance your living space with elegance and functionality.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {teaTableImages.map((img, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
      ...
      <section id="tv-unit" className="bg-luxury-cream scroll-mt-[100px]">
        <div className="container-luxury">
          <div className="text-center mb-16">
      ...
      <section id="wardrobe" className="bg-white scroll-mt-[100px]">
        <div className="container-luxury">
          <div className="text-center mb-16">
      ...
      <section id="main-door" className="bg-luxury-cream scroll-mt-[100px]">
        <div className="container-luxury">
          <div className="text-center mb-16">
